    ...
    return (
        <div className="about">
            ...
            <div className="about-info">
                <p>I'm currently a High School student interested in the Conputer Science field and am hoping to pursue a Masters in Software Engineering. I'm aspiring to be a part of a big company in either Software Engineering or Data Science where I get the opportunity to use a variety of languages on a frequent basis.</p>
