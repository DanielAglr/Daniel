function Intro() {
  return (
    <div className='w-[90vw] max-w-[1500px] h-[100vh]'>
      ...
      <div className='max-w-[55%] text-contrast-dark text-[20px] mb-[50px] md:max-w-[85%] md:my-[5vh] '>I'm a student from Long Beach. I'm very interested in full-stack development, data manipulation, and anything involving JavaScript.</div>
      <div>
